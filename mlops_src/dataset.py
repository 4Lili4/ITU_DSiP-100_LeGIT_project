...
import json
import os
from config import max_date, min_date, raw_data, interim_data, processed_data
...
with open("../data/artifacts/date_limits.json", "w") as f:
...
outlier_summary.to_csv('../data/artifacts/outlier_summary.csv')

#Impute missing data for categorical variables
cat_missing_impute = cat_vars.mode(numeric_only=False, dropna=True)
cat_missing_impute.to_csv("../data/artifacts/cat_missing_impute.csv")
...
with open('../data/artifacts/columns_drift.json','w+') as f:           
    json.dump(data_columns,f)

#Save interim training data
data.to_csv(interim_data, index=False)

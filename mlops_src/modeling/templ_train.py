...
def main(
    ...
    xgboost_model.save_model(xgboost_model_path) #Path defined in beginning of function
    ...
    #Autolog is initialised here, but where does it log to?
    ...
    results_path=str(model_results_path)

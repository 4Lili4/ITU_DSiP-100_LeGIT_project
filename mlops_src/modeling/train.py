...
import time
import os
from mlops_src.config import processed_data, experiment_name
...
xgboost_model_path = "../../data/artifacts/lead_model_xgboost.json"
...
with open('../../data/artifacts/columns_list.json', 'w+') as columns_file:
    columns = {'column_names': list(X_train.columns)}
    json.dump(columns, columns_file)

with open("../../data/artifacts/model_results.json", 'w+') as results_file:
...
with open("../../data/artifacts/model_results.json", "r") as f:

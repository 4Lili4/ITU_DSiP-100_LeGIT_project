# 100% LeGIT ITU BDS MLOPS'25 - Project
...
ITU MLOps project for 100% LeGIT group 2025
...
│                         cc_mlops_project and configuration for tools like black
│
...
│
└── cc_mlops_project   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes cc_mlops_project a Python module
    │
